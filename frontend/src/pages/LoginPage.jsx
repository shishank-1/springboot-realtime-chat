  ...
  return (
    <main className="flex min-h-screen items-center justify-center px-4">
      <form onSubmit={submit} className="w-full max-w-sm rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <p className="mt-1 text-sm text-slate-500">Continue your private chats.</p>
        ...
        <button className="mt-6 w-full rounded-md bg-emerald-600 px-4 py-2 font-medium text-white hover:bg-emerald-700">Login</button>
        <p className="mt-4 text-center text-sm text-slate-600">No account? <Link className="font-medium text-emerald-700" to="/register">Register</Link></p>
      </form>
    </main>
  );
}
